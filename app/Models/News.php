...
class News extends Model implements Viewable
{
    ...
    // {
    //     return $this->belongsToMany(Category::class, 'news_to_categories', 'news_id', 'category_id');
    // }
    ...
    public function scopeApplyFilter($query, $args = [])
    {
        ...
        if (!empty($args['category_id'])) {
            $query->join('news_to_categories', 'news.id', '=', 'news_to_categories.news_id');
            $query->where('news_to_categories.category_id', $args['category_id']);
        }
    }
