...
@section('title')
<title>Chỉnh sửa danh mục con - Admin</title>
@endsection
@section('css')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{URL::to('/update-type/'.$edit_types->id)}}" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="category_id[]" multiple="" class="chosen-select form-control tag-input-style" id="form-field-select-4">
