    ...
    <div class="page-title">
        ...
        <div class="title_right">
            <div class="pull-right">
                <a href="{{ route('admin.category.video.index') }}" class="btn btn-success"><i class="fa fa-arrow-left"></i> Quay về</a>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    {!! Form::ajax([
                        'url' => isset($category_id) ? route('admin.category.video.update', ['category' => $category->id]) : route('admin.category.video.store'),
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                @include('admin.components.form-select-category-video', [
