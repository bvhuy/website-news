    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form action="{{URL::to('/save-type-users')}}" class="form-horizontal" role="form" method="POST">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="name">Tên</label>

                            <div class="col-sm-9">
                                <input type="text" placeholder="Nhập danh mục con..." value="{{old('name')}}" name="name" id="name" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
