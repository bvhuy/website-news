    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form action="{{URL::to('/save-new-users')}}" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="content" id="add-new-content-users" placeholder="Nhập nội dung bài viết..." class="form-control">{{old('content')}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    CKEDITOR.replace('add-new-content-users',{
