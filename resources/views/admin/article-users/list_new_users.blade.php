...
@section('title')
<title>Danh sách bài viết - Users</title>
@endsection
@section('dashboard')
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th style="width: 110px">Danh mục con</th>
									...
									<tbody>
										...
										<tr>
                                            ...
                                            <td class="text-center">
                                                @if ($list_news->status_new_users == 0)
                                                <a class="btn btn-danger btn-sm" href="{{URL::to('/unactive-new-users/'.$list_news->id)}}">Nộp bài</a>
                                                <br><br>
                                                @else
                                                <a class="btn btn-success btn-sm" href="{{URL::to('/active-new-users/'.$list_news->id)}}">Thu hồi</a>
                                                <br><br>
                                                @endif
                                                {{-- <a class="btn btn-primary btn-sm" href="{{URL::to('/view-new-users/'.$list_news->id)}}">Xem</a> --}}
                                            </td>
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="green" href="{{URL::to('/edit-new-users/'.$list_news->id)}}">
													...
													<div class="modal fade" id="delete-category-{{$list_news->id}}" tabindex="-1" role="dialog" aria-labelledby="notify-label-{{$list_news->id}}" aria-hidden="true">
														...
														<div class="modal-content">
															...
															<a href="{{URL::to('/delete-new-users/'.$list_news->id)}}" class="btn btn-success">Có</a>
															</div>
														</div>
														</div>
													</div>
