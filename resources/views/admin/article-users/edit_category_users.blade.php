...
@section('title')
<title>Chỉnh sửa danh mục bài viết - Users</title>
@endsection
@section('dashboard')
    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    @foreach ($edit_category_users as $key => $edit_categories)
                    <form action="{{URL::to('/update-category-users/'.$edit_categories->id)}}" class="form-horizontal" role="form" method="POST">
                        {{ csrf_field() }}
