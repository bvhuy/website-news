...
@section('title')
<title>Chỉnh sửa bài viết - Users</title>
@endsection
@section('css')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{URL::to('/update-new-users/'.$edit_news->id)}}" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="content" id="edit-new-content-users" class="form-control">{{$edit_news->content}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    CKEDITOR.replace('edit-new-content-users',{
