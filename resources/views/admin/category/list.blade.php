                            ...
                            <tbody>
                                ...
                                <?php $dash=''; ?>
                                    <tr>
                                        <td>{{$_SESSION['i']}}</td>
                                        <td>
                                            <a href="{{ route('admin.category.edit', ['category' => $category->id]) }}" class="btn btn-info btn-xs">{{ $category->name }}</a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @if ($category->getNextSibling())
                                                <a href="{{ route('admin.category.down' , ['category' => $category->id]) }}" class="btn btn-danger btn-xs"><i class="fa fa-arrow-down"></i></a>
                                            @endif
                                            @if ($category->getPrevSibling())
                                                <a href="{{ route('admin.category.up' , ['category' => $category->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-arrow-up"></i></a>
                                            @endif
                                        </td>
                                        <td>
                                            @if($category->isDisable())
                                                <a data-function="enable" data-method="put" href="{{ route('admin.category.enable' , ['category' => $category->id]) }}" class="btn btn-danger btn-xs">Ẩn</a>
                                            @endif
                                            @if($category->isEnable())
                                                <a data-function="disable" data-method="put" href="{{ route('admin.category.disable' , ['category' => $category->id]) }}" class="btn btn-success btn-xs">Hiện</a>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.category.edit', ['category' => $category->id]) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Sửa </a>
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                      ...
                                                      <a data-function="destroy" data-method="delete" href="{{ route('admin.category.destroy', ['category' => $category->id]) }}" class="btn btn-danger">Xoá</a>
                                                    </div>
                                    ...
                                    @if(count($category->children))
                                        @include('admin.components.category-table-item',['category_childrens' => $category->children])
                                    @endif
                                @endforeach
                            </tbody>
                        </table>
